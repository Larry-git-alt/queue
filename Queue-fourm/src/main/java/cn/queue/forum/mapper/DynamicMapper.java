...
public interface DynamicMapper extends BaseMapper<Dynamic>{
    ...
    @Insert("insert into fourm.dynamic(user_id,content, url,likes, pid, target_id, create_time, update_time, create_by, update_by)" +
            " values (#{userId},#{content},#{url},#{likes},#{pid},#{targetId},#{createTime},#{updateTime},#{createBy},#{updateBy})")
